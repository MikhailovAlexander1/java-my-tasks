...
public class ScannerForWspp {
    private final BufferedReader reader;
    private final StringBuilder buffer = new StringBuilder();
    private int countLines = 1;

    public ScannerForWspp() {
        reader = new BufferedReader(new InputStreamReader(System.in));
    }

    public ScannerForWspp(String name, String encoding) throws FileNotFoundException, UnsupportedEncodingException {
    ...
    public boolean hasNext() throws IOException {
        ...
        while (!Character.isWhitespace((char) symbol) || buffer.isEmpty()) {
            ...
            if (Character.isLetter((char) symbol) || Character.getType((char) symbol) == Character.DASH_PUNCTUATION || (char) symbol == '\'') {
